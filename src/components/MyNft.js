    ...
    if (typeof window.ethereum !== "undefined") {
      ...
      if (window.ethereum.selectedAddress !== "undefined") {
        ...
        var firstWalletAdress =
          walletAdress.substring(0, walletAdress.length - 36) + "...";
        var lastWalletAdress = walletAdress.substring(
          38,
          walletAdress.length - 0
        );
    ...
    <>
      <div className="test hamburgertest" id="hamburger">
        <div class="vertical-header">
          ...
          <div class="image-top">
            <NavLink exact to="/" className="logo-top">
              GALLUS
            </NavLink>
          </div>
          <ul class="ul">
        ...
        <div className="logo-nav-wallet">
            ...
            <li class="menut-item">
              ...
              <a
                href="https://galluspaper.gallusfighter.com/"
                target="_blank"
                class="display left-docs"
              >
                {/* <i class="fas fa-coins yellow-icon"></i>Buy GALLUS */}
      ...
      <div className="pool">
        <div className="wallet-nav">
          ...
          <div className="logo-nav-wallet">
            ...
            <div className="pool1">Your Nft</div>
          </div>
          <div className="right-nav">
            <div className="right-item">
              {/* <a href="#my-nft" className="nft-owned ">}</a> */}

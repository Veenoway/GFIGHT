...
import CardTitan from "./CardTitan";
...
Stay tuned and enter the arena for NFT's fights.</p>
           ...
           <div className="menus">
               <div className="menu-list">
                   ...
                   <a href="/#nft-market/titan" className="menu-item selected-market" id="titan">Titan Feather</a>
               ...
               <div className="menu-list">
                ...
                <div id="mediumData">
                                {data.map((image) => (
                                    ...
                                    <CardTitan image={image} key={image.title} />
